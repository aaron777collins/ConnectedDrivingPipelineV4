...
LOG_NAME = "MClassifierLargePipelineUserNoXYOffsetPosNoMaxDistMapCreatorSuperEnlarged"
...
class MClassifierLargePipelineUserNoXYOffsetPosNoMaxDistMapCreatorSuperEnlarged:
...
if __name__ == "__main__":
    mcplu = MClassifierLargePipelineUserNoXYOffsetPosNoMaxDistMapCreatorSuperEnlarged()
    mcplu.run()
