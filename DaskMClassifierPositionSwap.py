"""
Dask-based MClassifier Pipeline for Position Swap attack detection.
...
class DaskMClassifierPositionSwap:
    """
    ...
    def run(self):
        self.logger.log("=" * 60)
        self.logger.log("DASK PIPELINE: Position Swap Attack Detection")
        self.logger.log("=" * 60)
...
if __name__ == "__main__":
    mcplu = DaskMClassifierPositionSwap()
    mcplu.run()
