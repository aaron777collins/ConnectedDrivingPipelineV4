...
LOG_NAME = "MClassifierLargePipelineUserWithXYOffsetPos2000mDistRandSplit80PercentTrain20PercentTestAllRowsONLYXYELEVHeadingSpeedCols30attackersTrainRandOffset10To20P1xN106y41P2xN105y41WithPtGraft80P120P2d01to30m04y2021"
...
class MClassifierLargePipelineUserWithXYOffsetPos2000mDistRandSplit80PercentTrain20PercentTestAllRowsONLYXYELEVHeadingSpeedCols30attackersTrainRandOffset10To20P1xN106y41P2xN105y41WithPtGraft80P120P2d01to30m04y2021:
    ...
    def run(self):
        ...
        train = StandardPositionalOffsetAttacker(train, "train").add_attackers().add_attacks_positional_offset_rand(min_dist=10, max_dist=20).get_data()
        ...
        test = StandardPositionalOffsetAttacker(test, "test").add_attackers().add_attacks_positional_offset_rand(min_dist=10, max_dist=20).get_data()
...
if __name__ == "__main__":
    mcplu = MClassifierLargePipelineUserWithXYOffsetPos2000mDistRandSplit80PercentTrain20PercentTestAllRowsONLYXYELEVHeadingSpeedCols30attackersTrainRandOffset10To20P1xN106y41P2xN105y41WithPtGraft80P120P2d01to30m04y2021()
    mcplu.run()
