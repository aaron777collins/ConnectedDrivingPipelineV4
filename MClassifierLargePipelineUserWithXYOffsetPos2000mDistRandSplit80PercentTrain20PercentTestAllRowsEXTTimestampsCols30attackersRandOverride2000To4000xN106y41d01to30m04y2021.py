...
from Generator.Attackers.Attacks.StandardPositionFromOriginAttacker import StandardPositionFromOriginAttacker
...
LOG_NAME = "MClassifierLargePipelineUserWithXYOffsetPos2000mDistRandSplit80PercentTrain20PercentTestAllRowsEXTTimestampsCols30attackersRandOverride2000To4000xN106y41d01to30m04y2021"
...
class MClassifierLargePipelineUserWithXYOffsetPos2000mDistRandSplit80PercentTrain20PercentTestAllRowsEXTTimestampsCols30attackersRandOverride2000To4000xN106y41d01to30m04y2021:
    ...
    def __init__(self):
        ...
        self._generatorPathProvider = GeneratorPathProvider(model=f"{initialGathererModelName}-CCDDWithTimestampsAndWithXYCoords-RandSplit80ptrain-20ptest-2000mdist-2000to4000mPositionalOverride-x{x_pos_str}y{y_pos_str}-dd01to30mm04yyyy2021", contexts={
        ...
        self.generatorContextProvider = GeneratorContextProvider(contexts={
            ...
            "ConnectedDrivingCleaner.cleanParams": f"clean_data_with_timestamps-within_rangeXY_and_date_range-WithXYCoords-RandSplit80ptrain-20ptest-2000mdist-2000to4000mPositionalOverride-x{x_pos_str}y{y_pos_str}dd01to30mm04yyyy2021", # makes cached data have info on if/if not we use timestamps for uniqueness
    ...
    def run(self):
        ...
        train = StandardPositionFromOriginAttacker(train, "train").add_attackers().add_attacks_positional_override_rand(min_dist=2000, max_dist=4000).get_data()
        test = StandardPositionFromOriginAttacker(test, "test").add_attackers().add_attacks_positional_override_rand(min_dist=2000, max_dist=4000).get_data()
...
if __name__ == "__main__":
    mcplu = MClassifierLargePipelineUserWithXYOffsetPos2000mDistRandSplit80PercentTrain20PercentTestAllRowsEXTTimestampsCols30attackersRandOverride2000To4000xN106y41d01to30m04y2021()
    mcplu.run()
