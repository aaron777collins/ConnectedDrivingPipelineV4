...
LOG_NAME = "MClassifierLargePipelineUserWithXYOffsetPos2000mDistRandSplit80PercentTrain20PercentTestAllRowsONLYXYELEVHeadingSpeedCols30train5testattackersRandOffset100To200P1xN106y41P2xN105y41WithPtGraft80P120P2d01to30m04y2021"
...
class MClassifierLargePipelineUserWithXYOffsetPos2000mDistRandSplit80PercentTrain20PercentTestAllRowsONLYXYELEVHeadingSpeedCols30train5testattackersRandOffset100To200P1xN106y41P2xN105y41WithPtGraft80P120P2d01to30m04y2021:
    ...
    def __init__(self):
        ...
        self._generatorPathProvider = GeneratorPathProvider(model=f"{initialGathererModelName}-CCDDWithTimestampsAndWithXYCoords-RandSplit80PercentTrain20PercentTest-30attackertrain-2000mdist-x{x_pos_str}y{y_pos_str}-WithPtGraft80P120P2-dd01to30mm04yyyy2021", contexts={
    ...
    def run(self):
        ...
        x_pos_str = MathHelper.convertNumToTitleStr(x_pos)
        y_pos_str = MathHelper.convertNumToTitleStr(y_pos)
        generatorPathProviderModel=f"{self.initialGathererModelName}-CCDDWithTimestampsAndWithXYCoords-RandSplit80PercentTrain20PercentTest-5attackertest-2000mdist-x{x_pos_str}y{y_pos_str}-LeftOverFromPtGraft80P120P2-dd01to30mm04yyyy2021"

        self.generatorContextProvider.add("ConnectedDrivingCleaner.cleanParams", f"clean_data_with_timestamps-within_rangeXY_and_date_range-WithXYCoords-RandSplit80PercentTrain20PercentTest-5attackertest-2000mdist-x{x_pos_str}y{y_pos_str}-LeftOverFromPtGraft80P120P2-dd01to30mm04yyyy2021") # makes cached data have info on if/if not we use timestamps for uniqueness)

        self.generatorContextProvider.add("ConnectedDrivingAttacker.attack_ratio", 0.05)
...
if __name__ == "__main__":
    mcplu = MClassifierLargePipelineUserWithXYOffsetPos2000mDistRandSplit80PercentTrain20PercentTestAllRowsONLYXYELEVHeadingSpeedCols30train5testattackersRandOffset100To200P1xN106y41P2xN105y41WithPtGraft80P120P2d01to30m04y2021()
    mcplu.run()
