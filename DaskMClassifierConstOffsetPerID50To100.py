"""
Dask-based MClassifier Pipeline for ConstOffsetPerID 50-100m attack detection.
...
- Attack: Constant Offset Per ID 50-100m
...
class DaskMClassifierConstOffsetPerID50To100:
    """
    ...
    def run(self):
        self.logger.log("=" * 60)
        self.logger.log("DASK PIPELINE: ConstOffsetPerID 50-100m Attack Detection")
        self.logger.log("=" * 60)
        ...
        self.logger.log("Adding ConstOffsetPerID 50-100m attacks to train set...")
        ...
        self.logger.log("Adding ConstOffsetPerID 50-100m attacks to test set...")
...
if __name__ == "__main__":
    mcplu = DaskMClassifierConstOffsetPerID50To100()
    mcplu.run()
