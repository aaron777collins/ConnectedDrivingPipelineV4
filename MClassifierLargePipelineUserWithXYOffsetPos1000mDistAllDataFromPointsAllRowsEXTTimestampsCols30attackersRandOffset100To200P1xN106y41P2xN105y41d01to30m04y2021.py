...
LOG_NAME = "MClassifierLargePipelineUserWithXYOffsetPos1000mDistAllDataFromPointsAllRowsEXTTimestampsCols30attackersRandOffset100To200P1xN106y41P2xN105y41d01to30m04y2021"
...
class MClassifierLargePipelineUserWithXYOffsetPos1000mDistAllDataFromPointsAllRowsEXTTimestampsCols30attackersRandOffset100To200P1xN106y41P2xN105y41d01to30m04y2021:
    ...
    def __init__(self):
        ...
        self._generatorPathProvider = GeneratorPathProvider(model=f"{initialGathererModelName}-CCDDWithTimestampsAndWithXYCoords-AllDataFromPoints-1000mdist-x{x_pos_str}y{y_pos_str}-dd01to30mm04yyyy2021", contexts={
        ...
        self.generatorContextProvider = GeneratorContextProvider(contexts={
            ...
            "ConnectedDrivingCleaner.cleanParams": f"clean_data_with_timestamps-within_rangeXY_and_date_range-WithXYCoords-AllDataFromPoints-1000mdist-x{x_pos_str}y{y_pos_str}dd01to30mm04yyyy2021", # makes cached data have info on if/if not we use timestamps for uniqueness
    ...
    def run(self):
        ...
        x_pos_str = MathHelper.convertNumToTitleStr(x_pos)
        y_pos_str = MathHelper.convertNumToTitleStr(y_pos)
        generatorPathProviderModel=f"{self.initialGathererModelName}-CCDDWithTimestampsAndWithXYCoords-AllDataFromPoints-1000mdist-x{x_pos_str}y{y_pos_str}-dd01to30mm04yyyy2021"

        self.generatorContextProvider.add("ConnectedDrivingCleaner.cleanParams", f"clean_data_with_timestamps-within_rangeXY_and_date_range-WithXYCoords-AllDataFromPoints-1000mdist-x{x_pos_str}y{y_pos_str}dd01to30mm04yyyy2021") # makes cached data have info on if/if not we use timestamps for uniqueness)
...
if __name__ == "__main__":
    mcplu = MClassifierLargePipelineUserWithXYOffsetPos1000mDistAllDataFromPointsAllRowsEXTTimestampsCols30attackersRandOffset100To200P1xN106y41P2xN105y41d01to30m04y2021()
    mcplu.run()
