"""
Dask-based MClassifier Pipeline for ConstPosPerCar 10-20m attack detection.
...
- Attack: Constant Position Per Car 10-20m
...
class DaskMClassifierConstPosPerCar10To20:
    """
    ...
    def run(self):
        self.logger.log("=" * 60)
        self.logger.log("DASK PIPELINE: ConstPosPerCar 10-20m Attack Detection")
        self.logger.log("=" * 60)
        ...
        self.logger.log("Adding ConstPosPerCar 10-20m attacks to train set...")
        train = StandardPositionalOffsetAttacker(train, "train").add_attackers().add_attacks_positional_offset_const_per_id_with_random_direction(min_dist=10, max_dist=20).get_data()
        
        self.logger.log("Adding ConstPosPerCar 10-20m attacks to test set...")
        test = StandardPositionalOffsetAttacker(test, "test").add_attackers().add_attacks_positional_offset_const_per_id_with_random_direction(min_dist=10, max_dist=20).get_data()
...
if __name__ == "__main__":
    mcplu = DaskMClassifierConstPosPerCar10To20()
    mcplu.run()
