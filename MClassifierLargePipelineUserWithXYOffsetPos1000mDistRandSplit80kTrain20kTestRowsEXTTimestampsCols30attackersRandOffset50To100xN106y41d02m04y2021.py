...
LOG_NAME = "MClassifierLargePipelineUserWithXYOffsetPos1000mDistRandSplit80kTrain20kTestRowsEXTTimestampsCols30attackersRandOffset50To100xN106y41d02m04y2021"
...
class MClassifierLargePipelineUserWithXYOffsetPos1000mDistRandSplit80kTrain20kTestRowsEXTTimestampsCols30attackersRandOffset50To100xN106y41d02m04y2021:
    ...
    def __init__(self):
        ...
        self._generatorPathProvider = GeneratorPathProvider(model=f"{initialGathererModelName}-CCDDWithTimestampsAndWithXYCoords-RandSplit80ktrain-20ktest-1000mdist-x{x_pos_str}y{y_pos_str}-dd02mm04yyyy2021", contexts={
        ...
        self.generatorContextProvider = GeneratorContextProvider(contexts={
            ...
            "ConnectedDrivingCleaner.cleanParams": f"clean_data_with_timestamps-within_rangeXY_and_day-WithXYCoords-RandSplit80ktrain-20ktest-1000mdist-x{x_pos_str}y{y_pos_str}dd02mm04yyyy2021", # makes cached data have info on if/if not we use timestamps for uniqueness
...
if __name__ == "__main__":
    mcplu = MClassifierLargePipelineUserWithXYOffsetPos1000mDistRandSplit80kTrain20kTestRowsEXTTimestampsCols30attackersRandOffset50To100xN106y41d02m04y2021()
    mcplu.run()
