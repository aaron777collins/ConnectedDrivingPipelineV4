...
LOG_NAME = "MClassifierLargePipelineUserWithXYOffsetPos2000mDistRandSplit80PercentTrain20PercentTestAllRowsONLYXYELEVHeadingSpeedCols30train5testattackersRandOffset100To200P1xN106y41P2xN105y41With2SeparatePointsd01to30m04y2021"
...
class MClassifierLargePipelineUserWithXYOffsetPos2000mDistRandSplit80PercentTrain20PercentTestAllRowsONLYXYELEVHeadingSpeedCols30train5testattackersRandOffset100To200P1xN106y41P2xN105y41With2SeparatePointsd01to30m04y2021:
    ...
    def run(self):
        ...
        x_pos_str = MathHelper.convertNumToTitleStr(x_pos)
        y_pos_str = MathHelper.convertNumToTitleStr(y_pos)
        generatorPathProviderModel=f"{self.initialGathererModelName}-CCDDWithTimestampsAndWithXYCoords-RandSplit80PercentTrain20PercentTest-5attackertest-2000mdist-x{x_pos_str}y{y_pos_str}-LeftOverFromSeparatePts-dd01to30mm04yyyy2021"

        self.generatorContextProvider.add("ConnectedDrivingCleaner.cleanParams", f"clean_data_with_timestamps-within_rangeXY_and_date_range-WithXYCoords-RandSplit80PercentTrain20PercentTest-5attackertest-2000mdist-x{x_pos_str}y{y_pos_str}-LeftOverFromSeparatePts-dd01to30mm04yyyy2021") # makes cached data have info on if/if not we use timestamps for uniqueness)
...
if __name__ == "__main__":
    mcplu = MClassifierLargePipelineUserWithXYOffsetPos2000mDistRandSplit80PercentTrain20PercentTestAllRowsONLYXYELEVHeadingSpeedCols30train5testattackersRandOffset100To200P1xN106y41P2xN105y41With2SeparatePointsd01to30m04y2021()
    mcplu.run()
