...
LOG_NAME = "MClassifierLargePipelineUserWithXYOffsetPos2000mDistRandSplit80PercentTrain20PercentTestAllRowsONLYXYELEVHeadingSpeedCols30attackersTrainRandOffset100To200P1xN106y41P2xN105y41WithPtGraftCond20P280P2d01to30m04y2021"
...
class MClassifierLargePipelineUserWithXYOffsetPos2000mDistRandSplit80PercentTrain20PercentTestAllRowsONLYXYELEVHeadingSpeedCols30attackersTrainRandOffset100To200P1xN106y41P2xN105y41WithPtGraftCond20P280P2d01to30m04y2021:
    ...
    def __init__(self):
        ...
        self._generatorPathProvider = GeneratorPathProvider(model=f"{initialGathererModelName}-CCDDWithTimestampsAndWithXYCoords-RandSplit80PercentTrain20PercentTest-30attackertrain-2000mdist-x{x_pos_str}y{y_pos_str}-WithPtGraft80P120P2WithNoP1InTrain-dd01to30mm04yyyy2021", contexts={
        ...
        self.generatorContextProvider = GeneratorContextProvider(contexts={
            ...
            "ConnectedDrivingCleaner.cleanParams": f"clean_data_with_timestamps-within_rangeXY_and_date_range-WithXYCoords-RandSplit80PercentTrain20PercentTest-30attackertrain-2000mdist-x{x_pos_str}y{y_pos_str}-WithPtGraft80P120P2WithNoP1InTrain-dd01to30mm04yyyy2021", # makes cached data have info on if/if not we use timestamps for uniqueness
    ...
    def run(self):
        ...
        x_pos_str = MathHelper.convertNumToTitleStr(x_pos)
        y_pos_str = MathHelper.convertNumToTitleStr(y_pos)
        generatorPathProviderModel=f"{self.initialGathererModelName}-CCDDWithTimestampsAndWithXYCoords-RandSplit80PercentTrain20PercentTest-30attackertest-2000mdist-x{x_pos_str}y{y_pos_str}-LeftOverFromPtGraft80P120P2WithNoP1InTrain-dd01to30mm04yyyy2021"

        self.generatorContextProvider.add("ConnectedDrivingCleaner.cleanParams", f"clean_data_with_timestamps-within_rangeXY_and_date_range-WithXYCoords-RandSplit80PercentTrain20PercentTest-30attackertest-2000mdist-x{x_pos_str}y{y_pos_str}-LeftOverFromPtGraft80P120P2WithNoP1InTrain-dd01to30mm04yyyy2021") # makes cached data have info on if/if not we use timestamps for uniqueness)
        ...
        # NOW HERES THE BIG CHANGE:
        # Instead of
        # adding the 20% test data to the train data
        # train = concat([train, test20])

        # we do
        train = test20 #to make it so that we don't have ANY P1 data but we replicate the conditions of the original experiment
...
if __name__ == "__main__":
    mcplu = MClassifierLargePipelineUserWithXYOffsetPos2000mDistRandSplit80PercentTrain20PercentTestAllRowsONLYXYELEVHeadingSpeedCols30attackersTrainRandOffset100To200P1xN106y41P2xN105y41WithPtGraftCond20P280P2d01to30m04y2021()
    mcplu.run()
