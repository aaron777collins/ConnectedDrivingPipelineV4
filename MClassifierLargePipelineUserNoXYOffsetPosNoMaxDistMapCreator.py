...
LOG_NAME = "MClassifierLargePipelineUserNoXYOffsetPosNoMaxDistMapCreator"
...
class MClassifierLargePipelineUserNoXYOffsetPosNoMaxDistMapCreator:
...
if __name__ == "__main__":
    mcplu = MClassifierLargePipelineUserNoXYOffsetPosNoMaxDistMapCreator()
    mcplu.run()
