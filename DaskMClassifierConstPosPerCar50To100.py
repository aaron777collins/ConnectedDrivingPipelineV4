"""
Dask-based MClassifier Pipeline for ConstPosPerCar 50-100m attack detection.
...
- Attack: Constant Position Per Car 50-100m
...
class DaskMClassifierConstPosPerCar50To100:
    """
    ...
    def run(self):
        self.logger.log("=" * 60)
        self.logger.log("DASK PIPELINE: ConstPosPerCar 50-100m Attack Detection")
        self.logger.log("=" * 60)
        ...
        self.logger.log("Adding ConstPosPerCar 50-100m attacks to train set...")
        ...
        self.logger.log("Adding ConstPosPerCar 50-100m attacks to test set...")
...
if __name__ == "__main__":
    mcplu = DaskMClassifierConstPosPerCar50To100()
    mcplu.run()
