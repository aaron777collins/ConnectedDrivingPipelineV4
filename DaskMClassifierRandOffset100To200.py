"""
Dask-based MClassifier Pipeline for RandOffset 100-200m attack detection.
...
class DaskMClassifierRandOffset100To200:
    """
    ...
    def run(self):
        self.logger.log("=" * 60)
        self.logger.log("DASK PIPELINE: RandOffset 100-200m Attack Detection")
        self.logger.log("=" * 60)
        ...
        self.logger.log("Adding RandOffset 100-200m attacks to train set...")
        train = StandardPositionFromOriginAttacker(train, "train").add_attackers().add_attacks_positional_offset_rand(min_dist=100, max_dist=200).get_data()
        
        self.logger.log("Adding RandOffset 100-200m attacks to test set...")
        test = StandardPositionFromOriginAttacker(test, "test").add_attackers().add_attacks_positional_offset_rand(min_dist=100, max_dist=200).get_data()
...
if __name__ == "__main__":
    mcplu = DaskMClassifierRandOffset100To200()
    mcplu.run()
