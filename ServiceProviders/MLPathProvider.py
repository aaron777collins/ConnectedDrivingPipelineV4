...
class MLPathProvider(IMLPathProvider):
    ...
    def __init__(self, contexts=None, model=None):
        ...
        if model is None:
            self.model: str = MLPathProvider.DEFAULT_MODEL_NAME
            print(BColors.WARNING + f"WARNING: NO MODEL PROVIDED so the class was set to: {MLPathProvider.DEFAULT_MODEL_NAME}" + BColors.ENDC)
