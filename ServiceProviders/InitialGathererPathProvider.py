...
class InitialGathererPathProvider(IInitialGathererPathProvider):
    ...
    def __init__(self, contexts=None, model=None):
        ...
        if model is None:
            self.model: str = InitialGathererPathProvider.DEFAULT_MODEL_NAME
            print(BColors.WARNING + f"WARNING: NO MODEL PROVIDED so the class was set to: {InitialGathererPathProvider.DEFAULT_MODEL_NAME}" + BColors.ENDC)
